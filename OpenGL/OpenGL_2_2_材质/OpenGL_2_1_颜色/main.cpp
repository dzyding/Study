...
int main(int argc, const char * argv[]) {
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        objectShader.setVec3("material.ambient", 0.1745, 0.01175, 0.01175);
        objectShader.setVec3("material.diffuse", 0.61424, 0.04136, 0.04136);
        objectShader.setVec3("material.specular", 0.727811, 0.626959, 0.626959);
