...
1. <a href="#1">Mybatis 逆向</a> 
    ...
    - <a href="#1.5">关于 Mybatis parametertype</a>  
...
### <a id="1.5">关于 Mybatis parametertype</a>

相关内容原文链接：https://blog.csdn.net/lixld/java/article/details/77980443

1. 单个参数

```
// 单个参数这里的 @param 注解可以省略
...
5. 只能传递一个参数，但实际所需参数既要包含String类型，又要包含List类型时的处理方法：
