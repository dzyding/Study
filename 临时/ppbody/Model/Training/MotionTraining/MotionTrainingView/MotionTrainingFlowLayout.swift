//
//  MotionTrainingFlowLayout.swift
//  PPBody
//
...
class MotionTrainingFlowLayout: UICollectionViewFlowLayout {
    ...
    let ScaleFactor : CGFloat = 0.8     //缩放系数  越大缩放越大
    ...
    override func layoutAttributesForElements(in rect: CGRect) -> [UICollectionViewLayoutAttributes]? {
        ...
        for attributes in array! {
            ...
            if distance < self.itemSize.width + visibleRect.width/2
            {
                ...
                let alpha = 1 - 2 * normalizedDistance
