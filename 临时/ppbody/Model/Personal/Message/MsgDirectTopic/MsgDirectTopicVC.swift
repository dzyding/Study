...
class MsgDirectTopicVC: BaseVC {
    ...
    override func viewDidLoad() {
        ...
        self.tableview.register(UINib(nibName: "MsgDirectTopicCell", bundle: nil), forCellReuseIdentifier: "MsgDirectTopicCell")
    ...
    func getData(_ page: Int)
    {
        ...
        request.isUser = true
        request.url = BaseURL.MsgTopicDirectionList
...
extension MsgDirectTopicVC: UITableViewDelegate,UITableViewDataSource
{
    ...
    public  func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "MsgDirectTopicCell", for: indexPath) as! MsgDirectTopicCell
