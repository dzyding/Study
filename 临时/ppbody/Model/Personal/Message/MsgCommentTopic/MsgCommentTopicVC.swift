...
class MsgCommentTopicVC: BaseVC {
    ...
    override func viewDidLoad() {
        ...
        self.tableview.register(UINib(nibName: "MsgCommentTopicCell", bundle: nil), forCellReuseIdentifier: "MsgCommentTopicCell")
    ...
    func getData(_ page: Int)
    {
        ...
        request.isUser = true
        request.url = BaseURL.MsgTopicCommentList
...
extension MsgCommentTopicVC: UITableViewDelegate,UITableViewDataSource
{
    ...
    public  func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "MsgCommentTopicCell", for: indexPath) as! MsgCommentTopicCell
