...
open class LBXScanViewController: BaseVC, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
   ...
   public  var isNeedCodeImage = false
    ...
    @objc open func startScan()
    {
        ...
        if (scanObj == nil)
        {
            ...
            if !ToolClass.isRightCamera()
            {
                let alertController = UIAlertController(title: "相机访问受限", message:"点击【设置】，允许访问您的相机", preferredStyle: UIAlertController.Style.alert)
    ...
    public func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [UIImagePickerController.InfoKey : Any])
    {
        ...
        showMsg(title: nil, message: NSLocalizedString("无法识别", comment: "无法识别"))
    }
