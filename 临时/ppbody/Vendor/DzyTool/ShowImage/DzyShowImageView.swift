...
class DzyShowImageView: UIView {
    ...
    fileprivate lazy var bgView: UIView = { //背景图
        ...
        let value: CGFloat = 51.0/255.0
        v.backgroundColor = UIColor(red: value,
                                    green: value,
                                    blue: value,
                                    alpha: 0.8)
        return v
...
extension DzyShowImageView: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView
            .dequeueReusableCell(withReuseIdentifier: kDzyShowImageCell, for: indexPath) as! DzyShowImageCell
