...
@IBDesignable public class PinCodeTextField: UIView {
    ...
    @IBInspectable public var placeholderTxt: String?
    ...
    public var font: UIFont = ToolClass.CustomFont(14)
    ...
    private func updateLabels() {
        let textHelper = TextHelper(text: text, placeholder: placeholderTxt, isSecure: isSecureTextEntry)
        for label in labels {
