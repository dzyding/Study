...
public class RadarChartView: UIView {
    ...
    public var webColor = UIColor.ColorHexWithAlpha("#999999", 0.2)
    public var minValue = CGFloat(0.0)
    public var maxValue = CGFloat(100.0)
    public var verticalChartInset = CGFloat(30.0)
    public var horizontalChartInset = CGFloat(30.0)
    public var titleAttributes = [NSAttributedString.Key.font: ToolClass.CustomFont(11),
                                  NSAttributedString.Key.foregroundColor: UIColor.ColorHex("#999999")]
    public var webTitleAttributes = [NSAttributedString.Key.font: ToolClass.CustomFont(12),
